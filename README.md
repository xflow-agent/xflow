...
| Agent | 职责 | 处理任务类型 |
|-------|------|-------------|
| PlannerAgent | 分解复杂任务 | Complex |
| CoderAgent | 编写/修改代码 | Coding, Simple |
| ReviewerAgent | 代码审查/分析 | Review, Analysis |

**验证测试**:
```
xflow> 创建一个新的用户认证模块，包含登录、注册、登出功能
